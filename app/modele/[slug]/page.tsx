  ...
  return (
    <main className="container">
      <div className="modelHeader">
        ...
        <p className="modelNote"> Modelul este un concept realizat de arhitecti si ingineri experti atestați. Proiectul final se personalizează pentru terenul și cerințele tale, pe baza documentațiilor de urbanism și a datelor din amplasament.</p>
      </div>
