      ...
      <div className="list">
        ...
        <div className="listItem">
          ...
          <ul style={{ paddingLeft: '20px', marginBottom: '15px', lineHeight: '1.6' }}>
            <li><strong>Costuri Disproporționate:</strong> Efortul financiar necesar pentru înlocuirea suprafețelor vitrate mari, refacerea integrală a finisajelor și consolidarea elementelor structurale avariate depășește cu mult investiția modică ce ar fi fost necesară inițial pentru o soluție tehnică superioară.</li>
            <li><strong>Haosul Relocării:</strong> O casă avariată obligă familia la o mutare de urgență. Într-un oraș afectat de seism, găsirea unei chirii sigure devine o provocare aproape imposibilă și extrem de costisitoare.</li>
            <li><strong>Logistica și Depozitarea:</strong> Costurile și efortul de a muta și depozita întregul mobilier și bunurile personale pe durata unor reparații care pot dura luni de zile reprezintă o povară ascunsă, dar uriașă.</li>
            <li><strong>Timp și Stres:</strong> Șantierul post-seism înseamnă luni de incertitudine și disconfort, timp în care viața de familie este suspendată.</li>
          </ul>
          <p>
            <strong>Concluzia noastră:</strong> Adoptarea unei soluții de proiectare reziliente, pe care noi o propunem, nu este un cost suplimentar, ci o asigurare pentru viitor. Investiția marginală de astăzi elimină riscul ca, după un cutremur, să pierdeți nu doar finisajele casei, ci și confortul, timpul și liniștea familiei dumneavoastră.
          </p>
        </div>
        ...
        <div className="listItem">
          ...
          <p>
            ...
            O casă bine proiectată nu înseamnă doar izolație, ci un sistem integrat și independent energetic:
          </p>
          <ul style={{ paddingLeft: '20px', marginTop: '10px', lineHeight: '1.6' }}>
            <li><strong>Climatizare premium:</strong> Pompe de căldură de înaltă eficiență (aer-apă sau sol-apă) cuplate cu sisteme de încălzire și răcire în pardoseală sau tavan, garantând un confort termic perfect, fără jeturi de aer.</li>
            <li><strong>Calitatea aerului (HRV):</strong> Ventilație continuă cu recuperare de căldură, dublată de sisteme de filtrare activă, ionizatoare și purificatoare, pentru un interior fără praf, polen sau poluanți.</li>
            <li><strong>Anvelopă termică:</strong> Izolație superioară continuă și tâmplărie tripan cu tratament Low-E care elimină punțile termice.</li>
            <li><strong>Independență energetică:</strong> Infrastructură complet pregătită pentru instalarea panourilor fotovoltaice și a sistemelor de stocare în baterii.</li>
          </ul>
        </div>
        ...
        <div className="listItem">
          <h3>11) Smart Home, AI & Securitate Avansată</h3>
          <p>
            Gândim infrastructura digitală (sistem centralizat KNX sau similar) pentru a permite casei să funcționeze proactiv, fără intervenții invazive ulterioare:
          </p>
          <ul style={{ paddingLeft: '20px', marginTop: '10px', lineHeight: '1.6' }}>
